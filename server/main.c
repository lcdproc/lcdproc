...
output_GPL_notice(void)
{
	...
	fprintf(stderr, "Copyright (C) 1998-2016 William Ferrell, Selene Scriven\n"
...
output_help_screen(void)
{
	...
	fprintf(stdout, "Copyright (c) 1998-2016 Selene Scriven, William Ferrell, and misc. contributors.\n");
