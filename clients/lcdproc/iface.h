...
int iface_screen(int rep, int display, int *flags_ptr, Elektra * elektra);
...
void format_value(char *buff, double value, IfaceUnit unit);
/** format value, scaling value and adding proper suffixes (for multi-interface
 * mode) */
void format_value_multi_interface(char *buff, double value, IfaceUnit unit);
